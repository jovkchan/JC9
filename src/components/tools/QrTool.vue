    ...
    <div v-if="activeTab === 'generate'" class="tool-body-split">
      <div class="settings-scroll-pane">
        ...
        <div class="setting-section">
          ...
          <JcTextarea v-model="qrText" beam glow :beam-size-ratio="0.6" :rows="4" placeholder="在此输入需要转换成二维码的文本或 URL 链接..." />
        </div>
        ...
        <div class="setting-section">
          ...
          <div class="config-group-card">
            ...
            <div class="flex-config-row mt-8">
              ...
              <div v-if="fgColorMode === 'gradient'" class="config-field">
                <label>渐变方向</label>
                <JcSelect beam glow :model-value="fgGradientDirection" :options="gradientDirectionOptions" style="width: 100%" @update:model-value="(v) => fgGradientDirection = v as 'horizontal' | 'vertical' | 'diagonal'" />
              </div>
            </div>
          </div>
          ...
          <div class="flex-config-row mt-10">
            ...
            <div class="config-field">
              ...
              <JcSelect beam glow :model-value="dotType" :options="dotTypeOptions" style="width: 100%" @update:model-value="(v) => dotType = v as DotShape" />
            </div>
            <div class="config-field">
              <label>码眼形状 (Finder Eyes)</label>
              <JcSelect beam glow :model-value="eyeType" :options="eyeTypeOptions" style="width: 100%" @update:model-value="(v) => eyeType = v as EyeShape" />
            </div>
          </div>
        ...
        <div class="setting-section">
          ...
          <div v-if="drawText" class="flex-config-row mt-8">
            <div class="config-field flex-2">
              <label>文字内容</label>
              <JcInput beam glow v-model="labelText" placeholder="例如：扫码查看详情" />
            </div>
            <div class="config-field">
              <label>文字颜色</label>
            ...
            <div class="config-field">
              <label>字号大小</label>
              <JcSelect beam glow :model-value="labelSize" :options="labelSizeOptions" style="width: 100%" @update:model-value="(v) => labelSize = Number(v)" />
            </div>
          </div>
        </div>
        ...
        <div class="setting-section">
          ...
          <div class="flex-config-row">
            <div class="config-field">
              ...
              <JcSelect beam glow :model-value="margin" :options="marginOptions" style="width: 100%" @update:model-value="(v) => margin = Number(v)" />
            </div>
            <div class="config-field">
              <label>二维码容错率</label>
              <JcSelect beam glow :model-value="errorCorrectionLevel" :options="errorCorrectionOptions" :disabled="logoType !== 'none'" style="width: 100%" @update:model-value="(v) => errorCorrectionLevel = v as 'L' | 'M' | 'Q' | 'H'" />
