...
<template>
  <ToolShell title="JWT 解码器">
    ...
    <div class="jwt-input-section">
      ...
      <JcTextarea v-model="tokenInput" mono beam glow :beam-size-ratio="0.6" :spellcheck="false" :rows="3" placeholder="在此处粘贴以 eyJ... 开头的三段式 JWT 令牌..." />
    </div>
    ...
    <div class="tool-body-split">
      <div class="editor-pane">
        ...
        <JcTextarea v-model="headerResult" mono readonly beam glow :beam-size-ratio="0.6" :spellcheck="false" class="jc-fill" placeholder="等待解析..." />
      </div>
      ...
      <div class="editor-pane flex-column-layout">
        ...
        <JcTextarea v-model="payloadResult" mono readonly beam glow :beam-size-ratio="0.6" :spellcheck="false" class="jc-fill" placeholder="等待解析..." />
