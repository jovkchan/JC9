    ...
    <div class="radix-inputs-list">
      <div class="radix-field-row">
        ...
        <div class="input-wrap">
          <JcInput class="code-font" :model-value="binVal" @update:model-value="updateValues('bin', $event)" placeholder="请输入二进制数据（如 101010）..." style="flex: 1; min-width: 0" />
      ...
      <div class="radix-field-row">
        ...
        <div class="input-wrap">
          <JcInput class="code-font" :model-value="octVal" @update:model-value="updateValues('oct', $event)" placeholder="请输入八进制数据（如 52）..." style="flex: 1; min-width: 0" />
      ...
      <div class="radix-field-row">
        ...
        <div class="input-wrap">
          <JcInput class="code-font" :model-value="decVal" @update:model-value="updateValues('dec', $event)" placeholder="请输入十进制数据（如 42）..." style="flex: 1; min-width: 0" />
      ...
      <div class="radix-field-row">
        ...
        <div class="input-wrap">
          <JcInput class="code-font" :model-value="hexVal" @update:model-value="updateValues('hex', $event)" placeholder="请输入十六进制数据（如 2A）..." style="flex: 1; min-width: 0" />
