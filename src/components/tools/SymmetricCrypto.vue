      ...
      <div class="left-pane card">
        ...
        <div class="field-item">
          <div class="label-with-select">
            <label>密钥 (Key)</label>
            <JcSelect beam glow v-model="keyFormat" :options="textFormatOptions" size="small" />
          </div>
          <JcInput beam glow v-model="key" placeholder="输入加密密钥..." style="font-family: 'Cascadia Code', Consolas, monospace" />
        ...
        <div class="field-item" v-show="mode === 'CBC'">
          <div class="label-with-select">
            <label>偏移量 (IV)</label>
            <JcSelect beam glow v-model="ivFormat" :options="textFormatOptions" size="small" />
          </div>
          <JcInput beam glow v-model="iv" placeholder="输入偏移量..." style="font-family: 'Cascadia Code', Consolas, monospace" />
          <div class="field-desc">
      ...
      <div class="right-pane">
        ...
        <div class="card val-panel">
          <div class="panel-header">
            ...
            <div class="panel-acts">
              <JcSelect beam glow v-model="plainFormat" :options="textFormatOptions" size="small" />
              <JcButton size="small" @click="copyResult(plainText)">复制</JcButton>
            </div>
          </div>
          <JcTextarea v-model="plainText" beam glow :beam-size-ratio="0.6" :rows="7" :spellcheck="false" placeholder="在此输入需要加密的明文，或解密出的结果..." />
        </div>
        ...
        <div class="card val-panel">
          <div class="panel-header">
            ...
            <div class="panel-acts">
              <JcSelect beam glow v-model="cipherFormat" :options="cipherFormatOptions" size="small" />
              <JcButton size="small" @click="copyResult(cipherText)">复制</JcButton>
            </div>
          </div>
          <JcTextarea v-model="cipherText" mono beam glow :beam-size-ratio="0.6" :rows="7" :spellcheck="false" placeholder="在此输入需要解密的密文，或加密出的结果..." />
        </div>
