...
<template>
  <ToolShell title="命名风格转换器" subtitle="Case Converter" split>
    <template #actions>
      <JcSelect v-model="convertType" :options="convertTypeOptions" size="small" />
    ...
    <template #left>
      <JcTextarea v-model="input" mono :spellcheck="false" class="jc-fill" placeholder="输入要转换风格的变量名，如 user_name 或 userName..." />
    </template>
